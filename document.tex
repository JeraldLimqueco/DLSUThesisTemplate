...
\newcommand{\documentTitle}{Microcontroller-based Automated Watering System For Gardening with Moisture Sensor} % put tilde (~) between words to indicate non-breaking adjacent words

\newcommand{\keywords}{microcontroller, automated, watering, system, gardening, moisture, sensor}
